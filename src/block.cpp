...
bool Block::can_down(const std::shared_ptr<Tile> (&tiles_)[MAX_ROWS + 1][MAX_COLS]) const
{
    for (int col = position_col_; col < position_col_ + BLOCK_LAYOUT_SIZE; col++)
    {
...
bool Block::can_left(const std::shared_ptr<Tile> (&tiles_)[MAX_ROWS + 1][MAX_COLS]) const
{
    for (int row = position_row_; row < position_row_ + BLOCK_LAYOUT_SIZE; row++)
    {
...
bool Block::can_right(const std::shared_ptr<Tile> (&tiles_)[MAX_ROWS + 1][MAX_COLS]) const
{
    for (int row = position_row_; row < position_row_ + BLOCK_LAYOUT_SIZE; row++)
    {
...
bool Block::can_rotate(const std::shared_ptr<Tile> (&tiles_)[MAX_ROWS + 1][MAX_COLS]) const
{
