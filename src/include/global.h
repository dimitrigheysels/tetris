...
constexpr int MAX_ROWS = 27; // 1 invisible at the top, 25 playfield, 1 boundary at the bottom
constexpr int MAX_COLS = 12; // 1 boundary at the left, 10 playfield, 1 boundary at the right
